...
Requires:       ros-humble-spdlog-vendor
...
BuildRequires:  ros-humble-spdlog-vendor
BuildRequires:  spdlog-devel
BuildRequires:  ros-humble-ros-workspace
Provides:       %{name}-devel = %{version}-%{release}
Provides:       %{name}-doc = %{version}-%{release}
Provides:       %{name}-runtime = %{version}-%{release}
Provides:       ros-humble-rcl-logging-packages(member)
...
%if 0%{?with_weak_deps}
Supplements:    ros-humble-rcl-logging-packages(all)
%endif
...
%changelog
* Mon Nov 07 2022 Chris Lalancette <clalancette@openrobotics.org> - 2.3.1-1
- Autogenerated by Bloom

* Tue Apr 19 2022 Chris Lalancette <clalancette@openrobotics.org> - 2.3.0-2
- Autogenerated by Bloom
