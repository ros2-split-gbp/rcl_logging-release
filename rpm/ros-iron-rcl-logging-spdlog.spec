...
Requires:       ros-iron-spdlog-vendor
...
BuildRequires:  ros-iron-spdlog-vendor
BuildRequires:  spdlog-devel
BuildRequires:  ros-iron-ros-workspace
Provides:       %{name}-devel = %{version}-%{release}
Provides:       %{name}-doc = %{version}-%{release}
Provides:       %{name}-runtime = %{version}-%{release}
Provides:       ros-iron-rcl-logging-packages(member)
...
%if 0%{?with_weak_deps}
Supplements:    ros-iron-rcl-logging-packages(all)
%endif
...
%changelog
* Thu Apr 20 2023 Chris Lalancette <clalancette@openrobotics.org> - 2.5.1-2
